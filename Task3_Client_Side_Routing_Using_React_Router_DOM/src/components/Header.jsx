  ...
  return (
    <header className="flex border-b py-3 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[65px] tracking-wide relative z-50">
      <div className="flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full">
        <NavLink href="javascript:void(0)" className="max-sm:hidden">
          <img src="https://readymadeui.com/readymadeui.svg" alt="logo" className="w-32" />
        </NavLink>
        <NavLink href="javascript:void(0)" className="hidden max-sm:block">
        ...
        >
          ...
          >
            ...
            <li className="max-lg:border-b max-lg:py-3 px-3">
              <NavLink to={"/"} href="javascript:void(0)" className="lg:hover:text-[#007bff] text-[#007bff] block text-[15px]">
                Home
              </NavLink>
            </li>
            <li className="max-lg:border-b max-lg:py-3 px-3">
              <NavLink  to={"/team"} href="javascript:void(0)" className="lg:hover:text-[#007bff] text-gray-800 block text-[15px]">
                Team
              </NavLink>
            </li>
            <li className="max-lg:border-b max-lg:py-3 px-3">
              <NavLink to={"/feature"} href="javascript:void(0)" className="lg:hover:text-[#007bff] text-gray-800 block text-[15px]">
                Feature
              </NavLink>
            </li>
            <li className="max-lg:border-b max-lg:py-3 px-3">
              <NavLink to={"/Blog"} href="javascript:void(0)" className="lg:hover:text-[#007bff] text-gray-800 block text-[15px]">
                Blog
              </NavLink>
            </li>
            <li className="max-lg:border-b max-lg:py-3 px-3">
              <NavLink href="javascript:void(0)" className="lg:hover:text-[#007bff] text-gray-800 block text-[15px]">
                About
              </NavLink>
            </li>
          </ul>
